...
#| label: fig-temps
#| fig-cap: "Durée d'adhésion à l'association"
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-combien_com
#| fig-cap: "Nombre de commissions"
# mise en forme du tableau pour l'histogramme
...
ggplot(combien_commission_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Nombre de commission", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-combien_com_actif
#| fig-cap: "Nombre de commission en tant que membre actif.ve"
# mise en forme du tableau pour l'histogramme
...
ggplot(combien_commmision_actif_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Nombre de commission (membre actif.ve)", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
  scale_y_continuous(limits = c(min(combien_commmision_actif_dt$Freq), 
                                max(combien_commmision_actif_dt$Freq + 0.5))) +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5),
        legend.position = "none")
```
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-freq_plen
#| fig-cap: "Fréquence de participation aux réunions plénières"
# mise en forme du tableau pour l'histogramme
...
ggplot(freq_plen_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Fréquence de participation aux plénières", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-evol_invest
#| fig-cap: "Evolution de l'investissement au sein de l'association"
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-evol_invest_com
#| fig-cap: "Dynamique d'évolution de l'investissement au sein de l'association"
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-evol_invest_com2
#| fig-cap: "Thèmes associés à la diminution de l'investissement au sein de l'association"
# diminution ----------------
...
#| label: fig-ressenti
#| fig-cap: "Ressenti personnel au sein de l'association"
...
ggplot(evol_ressenti_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Evolution ressenti", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-prob
#| fig-cap: "Problème au sein de l'association"
# mise en forme du tableau pour l'histogramme
...
ggplot(problem_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Problème au sein de l'association", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-prob_com
#| fig-cap: "Thèmes associés aux problèmes rencontrés au sein de l'association"
...
```{r echo=FALSE, warning=FALSE}
#| label: fig-apport
#| fig-cap: "Ce que l'association nous apporte personnellement"
...
ggplot(expression_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(round(pourcent, 1), " %")),
            vjust = 2) +
  labs(x = "Liberté d'expression", y = "Nombre de personnes",
       title = "") +
...
ggplot(ecoute_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(round(pourcent, 1), " %")),
            vjust = 2) +
  labs(x = "Sentiment d'écoute", y = "Nombre de personnes",
       title = "") +
  scale_y_continuous(breaks = seq(0, 100, by = 1)) +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
...
ggplot(inclusion_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  labs(x = "Sentiment d'inclusion", y = "Nombre de personnes",
       title = "") +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
  scale_y_continuous(breaks = seq(0, 100, by = 1)) +
...
ggplot(be_detail_counts,
  ...
  labs(
    title = "",
    x = "Sentiment de bien-être (conflit)",
    y = "Nombre de réponses"
  ) +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
...
ggplot(accueil_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Qualité de l'accueil", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
ggplot(connaissance_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Connaissance de l'asso pour implication", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
  scale_y_continuous(limits = c(min(connaissance_dt$Freq), 
                                max(connaissance_dt$Freq + 0.5)),
                       breaks = seq(0, 100, by = 1)) +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5),
        legend.position = "none")
```
...
ggplot(theme_counts,
  ...
  labs(
    title = "",
    x = "Thèmes associés à la connaissance de l'asso pour implication",
    y = "Nombre de citations"
  ) +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
...
ggplot(plen_fonc_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Efficacité de fonctionnement des plénières", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
ggplot(theme_counts,
  ...
  labs(
  title = "",
  x = "Thèmes associés au fonctionnement et à l'efficacité des plénières",
  y = "Nombre de citations"
) +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
...
ggplot(commission_fonc_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Fonctionnement des commissions", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
ggplot(theme_counts,
  ...
  labs(
    title = "",
    x = "Thèmes associés au fonctionnement des commissions",
    y = "Nombre de citations"
  ) +
  scale_fill_manual(values = flag_random) +
  theme_minimal() +
...
ggplot(lien_commission_cc_plen_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Liens entre les commissions, les plénières et le CC", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
ggplot(ref_commision_fonc_dt, aes(x = Var1, y = Freq, fill = Var1)) +
  ...
  geom_text(aes(label = paste0(pourcent, " %")),
            vjust = -0.5) +
  scale_fill_manual(values = flag_random) +
  labs(x = "Rôle fonctionnel attribués aux référents des commissions", y = "Nombre de personnes",
       title = "") +
  theme_minimal() +
...
nb_rep_idee_plen_fonc = length(idee_plen_fonc_dt1$idee_plen_fonc)
```
...
nb_rep_idee_commission_fonc = length(idee_commission_fonc_dt1$idee_commission_fonc)
```
...
nb_rep_idee_inclusion = length(idee_inclusion_dt1$idee_inclusion)
```
...
nb_rep_idee_horizontalite = length(idee_horizontalite_dt1$idee_horizontalite)
```
...
nb_rep_idee_horizontalite = length(idee_horizontalite_dt1$idee_transparence_argent)
```
...
nb_rep_idee_autre = length(idee_autre_dt1$idee_autre)
```
